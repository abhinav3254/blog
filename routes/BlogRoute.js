...
router.post('/create', upload.single('imageUrl'), async (req, res) => {
    try {
        ...
        return res.status(201).json({ message: 'Blog post created successfully.', blogId: savedBlog._id });

    } catch (err) {
        return res.status(500).json({ message: 'An error occurred while creating the blog post. Please try again later.', error: err.message });
    }
});
...
router.get('/all', async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while fetching blogs. Please try again later.', error: err.message });
    }
});
...
router.put('/like/:id', async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: 'Blog liked successfully.', likes: blog.like });

    } catch (err) {
        return res.status(500).json({ message: 'An error occurred while liking the blog. Please try again later.', error: err.message });
    }
});
...
router.put('/comment/:id', async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: 'Comment added successfully.', comment: savedComment });

    } catch (err) {
        return res.status(500).json({ message: 'An error occurred while adding the comment. Please try again later.', error: err.message });
    }
});
...
router.delete('/comment/:id', async (req, res) => {
    try {
        ...
        if (!blog) {
            return res.status(404).json({ message: 'Blog containing the comment not found.' });
        }
        ...
        return res.status(500).json({ message: 'An error occurred while deleting the comment. Please try again later.', error: err.message });
    }
});
...
router.put('/comment/:id', async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while updating the comment. Please try again later.', error: err.message });
    }
});
...
router.put('/update/:id', upload.single('imageUrl'), async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while updating the blog post. Please try again later.', error: err.message });
    }
});
...
router.delete('/delete/:id', async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while deleting the blog post. Please try again later.', error: err.message });
    }
});
...
router.get('/search', async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while searching for blogs.', error: err.message });
    }
});
...
router.get('/blog/:id', async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'An error occurred while fetching the blog details.', error: err.message });
    }
});
